...
func TestSecretList(t *testing.T) {
	...
	delSel, err := secrets.List(func(rel *rspb.Release) bool { return true }, "status=uninstalled")
	// check
	if err != nil {
	...
	dplOrDelSel, err := secrets.List(func(rel *rspb.Release) bool { return true }, "status in (uninstalled, deployed)")
	// check
	if err != nil {
